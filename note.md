...
# QAM_EDIT
WANDB_ENTITY=xxxyyymmm MUJOCO_GL=egl python main.py --run_group=reproduce --agent=agents/qam.py --tags=QAM_EDIT --seed=10001  --env_name=cube-double-play-singletask-task2-v0 --sparse=False --horizon_length=5 --agent.action_chunking=True --agent.inv_temp=1.0 --agent.fql_alpha=0.0 --agent.edit_scale=0.0 --online_steps=0
...
# DRIFT
WANDB_ENTITY=xxxyyymmm MUJOCO_GL=egl python main.py \
  --run_group=reproduce \
